export default `<h1>一级标题·字体111111111111111111111111111</h1>
...
<p><a href="https://www.jx3box.com" target="_blank" rel="noopener">新窗口绝对链接</a>，<a href="11111">当前窗相对链接</a>，<a id="test"></a>锚点</p>
<h2>二级标题·列表与表格</h2>
<h2>二级标题·列表与表格22222</h2>
<p style="text-align: right;">右对齐内容</p>
...
<p>&nbsp;</p>
<blockquote>
<p>引用内容文字引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字 引用内容文字</p>
</blockquote>
<h3>三级标题·表情、图片、媒体1</h3>
...
<pre class="e-summary">折叠头文本<br>哈哈哈哈哈</pre>
<pre class="e-details">被折叠区域文本</pre>
<p>&nbsp;</p>
<pre class="language-javascript"><code>function print(){
...
<h5>五级标题·剑三定制功能·图标、宏、奇穴、技能，Buff，物品，秘籍</h5>
<p>&nbsp;</p>
